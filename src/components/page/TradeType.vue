    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-tickets"></i> 交易类型</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
        ...
        <el-dialog title="新增" :visible.sync="addVisible" width="30%">
            <el-form ref="form" :model="form" label-width="80px">
                <el-form-item label="消费类型">
                   <el-input v-model="form.typeName" placeholder="输入消费类型"></el-input>
                </el-form-item>
            </el-form>
    ...
    async getData() {
      ...
      if (process.env.NODE_ENV === "development") {
        ...
        const result = await postHttp({
          url: "/record/tradeType/listCombo",
          params
        });
        if (!result) {
          return;
